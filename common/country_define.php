<?php
    $g_dft_country_code = "Taiwan";
    $g_country_code = ["Afghanistan" => "AF", "Aland Islands" => "AX", "Albania" => "AL", "Algeria" => "DZ"
                     ...
                     , "Ukraine" => "UA", "United Arab Emirates" => "AE", "UK" => "GB", "USA" => "US"
